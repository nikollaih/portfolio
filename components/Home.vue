        ...
        <div class="row justify-content-center align-items-center h-100">
          ...
          >
            <div class="slider-wrapper h-100">
              <div
                class="slider-content text-center mt--45 text-lg-left position-relative z-index11"
                data-aos="fade-right"
              ...
              >
                <h1 class="mb-15 white-text">
                  <span
                    class="sub-heading d-block text-uppercase theme-color mb-0"
                    >Hello I’m</span
                  >
                  Nikollai Hernández
                </h1>
          ...
          >
            <div class="slider-img pl-120 position-relative z-index1">
              <img src="/images/slider/person.png" alt="hero image" />
            </div>
            <!-- /slider-img -->
          </div>
          <!-- /col -->
