...
import { $fetch } from "/Users/user/Documents/dev/portfolio/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/user/Documents/dev/portfolio/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/user/Documents/dev/portfolio/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "/Users/user/Documents/dev/portfolio/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu } from "/Users/user/Documents/dev/portfolio/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "/Users/user/Documents/dev/portfolio/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index-IQ-YBssv.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-Cfw4qgrG.js").then((m) => m.default || m)),
  thames: defineAsyncComponent(() => import("./_nuxt/thames-BLu4FUOq.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Bh-WM2db.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-D_rvIzqB.js"));
